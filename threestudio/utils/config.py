...
def parse_structured(fields: Any, cfg: Optional[Union[dict, DictConfig]] = None) -> Any:
    # Get the argument names of the fields class
    valid_args = fields.__init__.__code__.co_varnames

    # Filter the cfg dictionary to only include valid arguments
    filtered_cfg = {k: v for k, v in cfg.items() if k in valid_args}

    # Pass the filtered dictionary to the fields class
