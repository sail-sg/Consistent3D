...
class RandomCameraIterableDataset(IterableDataset, Updateable):
    ...
    def collate(self, batch) -> Dict[str, Any]:
        ...
        # DEBUG: always sample elevation angles uniformly
        # elevation_deg = (
        ...
        if self.cfg.batch_uniform_azimuth:
            if not self.cfg.use_n_views:
                ...
                azimuth_deg = (torch.rand(self.batch_size) + torch.arange(self.batch_size) % self.cfg.n_views) / self.cfg.n_views * (
                    self.azimuth_range[1] - self.azimuth_range[0]
                ) + self.azimuth_range[0]
        else:
...
class RandomCameraIterableDataset_test(IterableDataset, Updateable):
    def __init__(self, cfg: Any) -> None:
        super().__init__()
        self.cfg: RandomCameraDataModuleConfig = cfg
        self.heights: List[int] = (
    ...
    def collate(self, batch) -> Dict[str, Any]:
        ...
        if self.cur >= 120:
            raise StopIteration
        azimuth_deg = torch.linspace(0, 360.0, 120)[self.cur]
...
class RandomCameraDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None) -> None:
        ...
        if stage in [None, "test", "predict"]:
            ...
            # self.test_dataset = RandomCameraIterableDataset_test(self.cfg)
